...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to tlulMaster() in tlulMaster.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your tlulMaster.v for the exact path:
    ...
    # For a simple tlulMaster, dut.count.value *might* work, depending on Verilator's flattening.
